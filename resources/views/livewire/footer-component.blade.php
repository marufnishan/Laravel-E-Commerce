						...
						<div class="back-link-box">
							...
							<div class="back-link-row">
								<ul class="list-back-link" >
									...
									<li><a href="#" class="redirect-back-link" title="mobile">Samsung</a></li>
									<li><a href="#" class="redirect-back-link" title="yphones">Iphone</a></li>
									<li><a href="#" class="redirect-back-link" title="Gianee Mobiles GL">One Plus</a></li>
									<li><a href="#" class="redirect-back-link" title="Mobiles Karbonn">Walton</a></li>
									
								</ul>

								<ul class="list-back-link" >
									<li><span class="row-title">Tablets:</span></li>
									<li><a href="#" class="redirect-back-link" title="Plesc YPads">Samsung</a></li>
									<li><a href="#" class="redirect-back-link" title="Samsyng Tablets" >Iphone</a></li>
									<li><a href="#" class="redirect-back-link" title="Qindows Tablets" >One Plus</a></li>
									<li><a href="#" class="redirect-back-link" title="Calling Tablets" >Walton</a></li>
								</ul>

								<ul class="list-back-link" >
									<li><span class="row-title">Fashion:</span></li>
									<li><a href="#" class="redirect-back-link" title="Sarees Silk" >Rich Man</a></li>
									<li><a href="#" class="redirect-back-link" title="sarees Salwar" >Yellow</a></li>
									<li><a href="#" class="redirect-back-link" title="Suits Lehengas" >Twelve</a></li>
									<li><a href="#" class="redirect-back-link" title="Biba Jewellery" >Infinity</a></li>
								</ul>
